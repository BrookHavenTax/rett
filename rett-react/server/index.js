...
const TAX_EXTRACT_PROMPT = [
  ...
  '  - "Long-Term Capital Gain" / "LT Capital Gain" / 1099-B long-term',
  '    proceeds / Schedule D line 15 → longTermGain. This is non-',
  '    property LT gain (securities, crypto, partnership distributions).',
  '    If the document explicitly attributes the LT gain to a real-',
  '    estate sale, return null — property gain is entered separately.',
